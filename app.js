...
var edu = EDUCATION.map(function(e){ return Object.assign({}, e, {isEdu:true}); });
var all = EXPERIENCE.concat(edu);
el.innerHTML = all.map(function(e, i){
return '<div class="tl-item"><span class="tl-dot sw' + (i % 5) + '"></span><div class="tl-card">'
+ '<div class="tl-role-half">'
+ '<span class="tl-date">' + (e.isEdu ? '<span class="tl-tag">Education</span>' : '') + e.date + '</span>'
+ '<h3>' + e.role + '</h3>'
+ '<p>' + e.desc + '</p>'
+ '</div>'
